...
BASE_DIR = Path(__file__).resolve().parents[2]  # repo root (manage.py lives here)
...
if DEBUG and is_installed("django_browser_reload"):
...
if ENABLE_LDAP:
    ...
    # Optional: if you actually use django-python3-ldap, load it only when LDAP is enabled
